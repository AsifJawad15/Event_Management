...
<head>
    ...
    <title>Admin Panel - Create Schedule Day</title>
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin_schedule_day_store') }}" method="post">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="day" value="{{ old('day') }}" required placeholder="e.g., Day 1, Day 2">
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" class="form-control" name="order1" value="{{ old('order1') }}" required placeholder="e.g., 1, 2, 3">
                                    </div>
                                    <div class="mb-4">
