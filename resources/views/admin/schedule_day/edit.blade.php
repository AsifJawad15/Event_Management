...
<head>
    ...
    <title>Admin Panel - Edit Schedule Day</title>
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin_schedule_day_update', $schedule_day->id) }}" method="post">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="day" value="{{ old('day', $schedule_day->day) }}" required placeholder="e.g., Day 1, Day 2">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Date *</label>
                                        <input type="date" class="form-control" name="date1" value="{{ old('date1', $schedule_day->date1) }}" required>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Order *</label>
                                        <input type="number" class="form-control" name="order1" value="{{ old('order1', $schedule_day->order1) }}" required placeholder="e.g., 1, 2, 3">
                                    </div>
                                    <div class="mb-4">
                                        <button type="submit" class="btn btn-primary">Update</button>
                                        <a href="{{ route('admin_schedule_day_index') }}" class="btn btn-secondary">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
