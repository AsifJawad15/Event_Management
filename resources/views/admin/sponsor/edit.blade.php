...
<head>
    ...
    <title>Admin Panel - Edit Sponsor</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Edit Sponsor Information</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin_sponsor_update', $sponsor->id) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <select name="sponsor_category_id" class="form-control" required>
                                                    ...
                                                    @foreach($sponsorCategories as $category)
                                                        <option value="{{ $category->id }}"
                                                            {{ (old('sponsor_category_id') ?? $sponsor->sponsor_category_id) == $category->id ? 'selected' : '' }}>
                                                            {{ $category->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Tagline</label>
                                                <input type="text" name="tagline" class="form-control" value="{{ old('tagline') ?? $sponsor->tagline }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="email" name="email" class="form-control" value="{{ old('email') ?? $sponsor->email }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Phone</label>
                                                <input type="text" name="phone" class="form-control" value="{{ old('phone') ?? $sponsor->phone }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Website</label>
                                                <input type="url" name="website" class="form-control" value="{{ old('website') ?? $sponsor->website }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" rows="4">{{ old('description') ?? $sponsor->description }}</textarea>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <small class="text-muted">Leave empty to keep current logo. JPG, JPEG, PNG, GIF. Max 2MB.</small>
                                                @if($sponsor->logo)
                                                    <div class="mt-2">
                                                        <strong>Current Logo:</strong><br>
                                                        <img src="{{ asset('uploads/'.$sponsor->logo) }}" alt="Current Logo" style="width: 100px; height: 100px; object-fit: cover;" class="rounded">
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="featured_photo" class="form-control" accept="image/*">
                                                <small class="text-muted">Leave empty to keep current photo. JPG, JPEG, PNG, GIF. Max 2MB.</small>
                                                @if($sponsor->featured_photo)
                                                    <div class="mt-2">
                                                        <strong>Current Photo:</strong><br>
                                                        <img src="{{ asset('uploads/'.$sponsor->featured_photo) }}" alt="Current Photo" style="width: 100px; height: 100px; object-fit: cover;" class="rounded">
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="facebook" class="form-control" value="{{ old('facebook') ?? $sponsor->facebook }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Twitter</label>
                                                <input type="url" name="twitter" class="form-control" value="{{ old('twitter') ?? $sponsor->twitter }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="linkedin" class="form-control" value="{{ old('linkedin') ?? $sponsor->linkedin }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Instagram</label>
                                                <input type="url" name="instagram" class="form-control" value="{{ old('instagram') ?? $sponsor->instagram }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="map" class="form-control" rows="4" placeholder="Paste Google Maps embed iframe code here">{{ old('map') ?? $sponsor->map }}</textarea>
