                        ...
                        <form action="{{ route('admin_organiser_store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    @error('photo')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <small class="form-text text-muted">Upload a photo (JPEG, PNG, JPG, GIF). Max size: 2MB</small>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="biography"
                                              ...
                                              rows="4"
                                              placeholder="Brief description about the organiser...">{{ old('biography') }}</textarea>
                                    @error('biography')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-success">
                                    <i class="fas fa-save"></i> Create Organiser
                                </button>
