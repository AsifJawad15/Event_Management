                                ...
                                <table id="example1" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin_attendee_edit',$attendee->id) }}" class="btn btn-primary btn-sm" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="{{ route('admin_attendee_delete',$attendee->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')" title="Delete">
