                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="email" class="form-control" name="email" value="{{ $attendee->email }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="password" class="form-control" name="confirm_password" value="" placeholder="Leave blank to keep current password">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
