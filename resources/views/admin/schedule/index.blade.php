...
<head>
    ...
    <title>Admin Panel - Schedules</title>
                                    ...
                                    <table class="table table-bordered" id="example1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('uploads/'.$schedule->photo) }}" alt="" class="w_100">
                                                </td>
                                                <td>{{ $schedule->scheduleDay->day }}</td>
                                                <td>{{ $schedule->title }}</td>
                                                <td>{{ $schedule->location }}</td>
                                                <td>{{ $schedule->time }}</td>
                                                <td>{{ $schedule->item_order1 }}</td>
                                                <td class="pt_10 pb_10">
                                                    <a href="{{ route('admin_schedule_edit', $schedule->id) }}" class="btn btn-primary">Edit</a>
                                                    <form action="{{ route('admin_schedule_destroy', $schedule->id) }}" method="POST" style="display: inline-block;" onsubmit="return confirm('Are you sure you want to delete this schedule?')">
                                                        @csrf
                                                        @method('DELETE')
...
<script>
    $(document).ready(function() {
        $('#example1').DataTable({
            "order": [[ 6, "asc" ]] // Order by 'Order' column
        });
    });
</script>
