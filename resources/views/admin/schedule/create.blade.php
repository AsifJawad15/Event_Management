...
<head>
    <meta charset="UTF-8">
    <meta content="width=device-width, initial-scale=1,                 <li><a class="nav-link" href="{{ route('admin_schedule_index') }}"><i class="fas fa-hand-point-right"></i> <span>Schedules</span></a></li>
                ...
                <li><a class="nav-link" href="{{ route('admin_profile') }}"><i class="fas fa-hand-point-right"></i> <span>Profile</span></a></li>ximum-scale=1, shrink-to-fit=no" name="viewport">

    <link rel="icon" type="image/png" href="{{ asset('uploads/favicon.png') }}">

    <title>Admin Panel - Create Schedule</title>
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin_schedule_store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-control" name="schedule_day_id" required>
                                            ...
                                            @foreach($schedule_days as $schedule_day)
                                                <option value="{{ $schedule_day->id }}" {{ old('schedule_day_id') == $schedule_day->id ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="title" value="{{ old('title') }}" required placeholder="e.g., Opening Ceremony">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Description *</label>
                                        <textarea class="form-control" name="description" rows="4" required placeholder="Enter description">{{ old('description') }}</textarea>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Location *</label>
                                        <input type="text" class="form-control" name="location" value="{{ old('location') }}" required placeholder="e.g., Main Hall, Room A">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Time *</label>
                                        <input type="text" class="form-control" name="time" value="{{ old('time') }}" required placeholder="e.g., 10:00 AM - 11:00 AM">
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" class="form-control" name="item_order1" value="{{ old('item_order1') }}" required placeholder="e.g., 1, 2, 3">
                                    </div>
                                    <div class="mb-4">
