...
<head>
    ...
    <title>Admin Panel - Speakers</title>
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-button">
                    <a href="{{ route('admin_speaker_create') }}" class="btn btn-primary">Add Speaker</a>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($speaker->photo && file_exists(public_path('uploads/'.$speaker->photo)))
                                                        <img src="{{ asset('uploads/'.$speaker->photo) }}" alt="{{ $speaker->name }}" class="rounded" style="width: 50px; height: 50px; object-fit: cover;">
                                                    @else
                                                ...
                                                <td class="pt_10 pb_10">
                                                    <a href="{{ route('admin_speaker_edit', $speaker->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                                    <a href="{{ route('admin_speaker_destroy', $speaker->id) }}" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure?');">Delete</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
