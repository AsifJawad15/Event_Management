...
<head>
    ...
    <title>Admin Panel - Create Speaker</title>
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin_speaker_store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <small class="form-text text-muted">Upload speaker photo (Max: 10MB)</small>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Biography *</label>
                                        <textarea class="form-control" name="biography" rows="5" required>{{ old('biography') }}</textarea>
                                    </div>
                                    <div class="mb-4">
