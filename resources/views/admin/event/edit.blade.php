                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="location" value="{{ old('location', $event->location) }}" placeholder="City, Country">
                                            @error('location')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <label>Venue</label>
                                            <input type="text" class="form-control" name="venue" value="{{ old('venue', $event->venue) }}" placeholder="Venue Name">
                                            @error('venue')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="date" class="form-control" name="start_date" value="{{ old('start_date', $event->start_date->format('Y-m-d')) }}" required>
                                            @error('start_date')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="date" class="form-control" name="end_date" value="{{ old('end_date', $event->end_date->format('Y-m-d')) }}" required>
                                            @error('end_date')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="mb-2">
                                                <img src="{{ asset('uploads/'.$event->banner_image) }}" alt="Banner" style="max-width: 100%; height: auto; border-radius: 5px;">
                                            </div>
                                            @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="mb-2">
                                                <img src="{{ asset('uploads/'.$event->thumbnail_image) }}" alt="Thumbnail" style="max-width: 100%; height: auto; border-radius: 5px;">
                                            </div>
                                            @endif
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label>Price ($)</label>
                                            <input type="number" class="form-control" name="price" value="{{ old('price', $event->price) }}" min="0" step="0.01">
                                            @error('price')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label>Tags</label>
                                            <input type="text" class="form-control" name="tags" value="{{ old('tags', $event->tags) }}" placeholder="conference, tech, innovation (comma separated)">
                                            @error('tags')
                                            <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="email" class="form-control" name="organizer_email" value="{{ old('organizer_email', $event->organizer_email) }}">
