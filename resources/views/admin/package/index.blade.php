                                ...
                                <table id="example1" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $package->maximum_tickets ?? 'Unlimited' }}</td>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST" action="{{ route('admin_package_delete', $package->id) }}" style="display: inline-block;">
                                                    @csrf
                                                    @method('DELETE')
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Facilities for {{ $package->name }}</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                @if($package->facilities->count() > 0)
                                                                    ...
                                                                    <div class="form-group row bdb1 pt_10 mb_0">
                                                                        <div class="col-md-12">
                                                                            <i class="fas fa-check text-success"></i> {{ $facility->name }}
                                                                            <span class="badge badge-{{ $facility->status == 1 ? 'success' : 'danger' }}">
                                                                    ...
                                                                    @endforeach
                                                                @else
                                                                    <p class="text-muted">No facilities assigned to this package.</p>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
